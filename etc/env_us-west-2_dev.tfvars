...
ecs_services = {
  user-service = {
    ...
    containers = {
      user = {
        image                    = "273354644813.dkr.ecr.us-west-2.amazonaws.com/optimus/backend/user:develop-d0097a6"
  ...
  application-service = {
    ...
    containers = {
      application = {
        image     = "273354644813.dkr.ecr.us-west-2.amazonaws.com/optimus/backend/application:latest"
        essential = true
