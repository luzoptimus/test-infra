...
variable "aws_account_id" {
  type        = string
  description = "Account ID of the state terraform"
}
...
variable "forward_header_values" {
  ...
  default     = ["Access-Control-Request-Headers", "Access-Control-Request-Method", "Origin", "Host"]
}
...
variable "enabled_functions" {
  description = "Enable fucntions in the cloudfront"
  type        = bool
  default     = false
}

variable "runtime" {
  description = "Identificador de runtime que correra los js en cloudfront"
  default     = "cloudfront-js-1.0"
}

variable "publish" {
  description = "Habilita la opcion de publicarlo"
  type        = bool
  default     = true
}

variable "code" {
  description = "ubicacion del archivo js"
  default     = ""
}
